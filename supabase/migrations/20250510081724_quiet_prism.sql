/*
  ...
  1. Functions
     - `handle_new_login`: Creates session records on user login
     - `handle_logout`: Updates session records on user logout
  
  2. Triggers
     - Adds triggers to auth.users table for login/logout events
  
  3. Policies
     - Adds RLS policies for user_sessions table with existence checks
*/
